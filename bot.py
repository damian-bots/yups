        ...
        await msg.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/botz_x_hub")
                    ],
                ]
            )
        )
